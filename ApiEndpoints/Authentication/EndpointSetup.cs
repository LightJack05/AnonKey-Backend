...
public static class EndpointSetup
{
    ...
    public static void MapEndpoints(WebApplication app)
    {
        ...
        app.MapPost("/authentication/refreshRefreshToken", RefreshEndpointRefreshToken.PostRefreshRefreshToken).WithTags("Authentication").WithOpenApi().RequireAuthorization("user");
