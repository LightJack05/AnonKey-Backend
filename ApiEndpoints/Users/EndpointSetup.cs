...
public static class EndpointSetup 
{
    ...
    public static void MapEndpoints(WebApplication app)
    {
        ...
        app.MapGet("/user/get", Get.GetGet).WithTags("Users").WithOpenApi();
        app.MapPut("/user/update", Update.PutUpdate).WithTags("Users").WithOpenApi();
        app.MapDelete("/user/delete", Delete.DeleteDelete).WithTags("Users").WithOpenApi();
    }
}
